...
public class HomographyPart2 : MonoBehaviour {

    public double[,] s = new double[5, 2] { { 100, 100 }, { 300, 200 }, { 100, 400 }, { 200, 500 }, { 200, 300 } };

    // image 1
    public double[,] d1 = new double[5, 2] { { 706,755 }, { 933,1221 }, {1393,767 }, { 1624,997 } , { 1166 ,994} };
    // image 2
    public double[,] d2 = new double[5, 2] { {508 ,740 }, {732 ,1208 }, {1208 , 724 }, {1448 , 960 }, { 968, 968 } };
    // image 3
    public double[,] d3 = new double[5, 2] { { 748 , 876, }, { 980 , 1376 }, {  1460, 924 }, {  1664 , 1168 }, {  1220 , 1148 } };
    ...
    private void Start()
    {
        ...
        double[,] hm1 = Homography.HomographyMatrixCalculator(s, d1);
        double[,] hm2 = Homography.HomographyMatrixCalculator(s, d2);
        double[,] hm3 = Homography.HomographyMatrixCalculator(s, d3);
        ...
        Homography.ProjectionMatrixCalculator(hm1, p1, true);
        Homography.ProjectionMatrixCalculator(hm1, p2, true);
        Homography.ProjectionMatrixCalculator(hm1, p3, true);
        Debug.Log("Projection For Image 2");
        Homography.ProjectionMatrixCalculator(hm2, p1, true);
        Homography.ProjectionMatrixCalculator(hm2, p2, true);
        Homography.ProjectionMatrixCalculator(hm2, p3, true);
        Debug.Log("Projection For Image 3");
        Homography.ProjectionMatrixCalculator(hm3, p1, true);
        Homography.ProjectionMatrixCalculator(hm3, p2, true);
        Homography.ProjectionMatrixCalculator(hm3, p3, true);
    ...
    private void CalculatePointMatchesAndErrors(double[,] hm, double[,] s, double[,] d, List<double[,]> P, List<double[,]> actualP)
    {
        ...
        {
            double[,] uv = actualP[k++];
            var res = Homography.ProjectionMatrixCalculator(hm, xy, true);     // projection
