...
public class CreateCube2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        foreach (string line in System.IO.File.ReadLines(@"D:\file2.txt"))

        {
            ...
            else
            {
                ...
                sphere.GetComponent<Renderer>().material.color = new Color32(0, 247, 255, 255);
            }
        }
